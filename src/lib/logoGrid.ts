...
const ISOTYPE_ACTIVE_COVERAGE = 0.2
const ISOTYPE_DIRECT_ACCEPT_COVERAGE = 0.9
...
const ISOTYPE_MAX_SUBDIVISION_DEPTH = 4
const WORDMARK_MAX_SUBDIVISION_DEPTH = 4
const GRID_LATTICE_SCALE = 1 << WORDMARK_MAX_SUBDIVISION_DEPTH
